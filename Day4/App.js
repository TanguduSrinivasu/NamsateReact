...
const restarauntList = [
  {
    ...
    "data": {
      ...
      "slugs": {
        "restaurant": "kwality-walls-frozen-dessert-and-ice-cream-shop-adyar-adyar-5",
        "city": "chennai"
      },
      "cityState": "8",
      "address": "ELAKKIYA: NO.43/59, 2ND STREET, VARADHAPURAM, KOTTUR, KOTTURPURAM, CHENNAI, Chennai Corporation Ward - 172, Tamil Nadu -600085 (HUL- I41B290P2426)\"",
  ...
  },
  {
    ...
    "data": {
      ...
      "cityState": "8",
      "address": "P.GOPINATH, No.23/38, P.E. KOVIL STREET, AYANAVARAM, Chennai,600023",
  ...
  },
  {
    ...
    "data": {
      ...
      "cityState": "8",
      "address": "6/93, D Block 3rd St, Block D, D Block, Annanagar East, Chennai, Tamil Nadu 600102",
      "locality": "Anna Nagar",
      "parentId": 135956,
      "unserviceable": false,
      "veg": false,
  ...
  },
  {
    ...
    "data": {
      ...
      "cityState": "8",
      "address": "No.1 Teeds Garden 5th Street Sembium Perambur,Chennai Corp. Ward - 68 Chennai,Tamil Nadu, 600011",
      "locality": "Sembium",
      "parentId": 195120,
      "unserviceable": false,
      "veg": false,
...
//             restarauntList[0].data?.cloudinaryImageId} alt="Restaurant Image" />
//             <h2>{restarauntList[0].data?.name}</h2>
//             <h3>{restarauntList[0].data?.cuisines.join(", ")}</h3>
//             <h4>{restarauntList[0].data?.lastMileTravelString} minutes</h4>
//       </div>
//   )
// }
...
//             <img src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/"+
//             props.restaurant?.cloudinaryImageId} alt="Restaurant Image" />
...
// const RestarauntCard = ({restaurant}) => {
...
//           <img src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/"+
//           cloudinaryImageId} alt="Restaurant Image" />
//           <h2>{name}</h2>
//           <h3>{cuisines.join(", ")}</h3>
...
//         <RestarauntCard restaurant={restarauntList[0].data}/>
//         <RestarauntCard restaurant={restarauntList[1].data}/>
//         <RestarauntCard restaurant={restarauntList[2].data}/>
//         <RestarauntCard restaurant={restarauntList[3].data}/>
//         <RestarauntCard restaurant={restarauntList[4].data}/>
//     </div>
//     )
// }
